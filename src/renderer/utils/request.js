...
var _require = require('./env'),
  debugRequest = _require.debugRequest;
var _require2 = require('./message'),
  requestMsg = _require2.requestMsg;
var _require3 = require('./musicSdk/options'),
  bHh = _require3.bHh;
var _require4 = require('zlib'),
  deflateRaw = _require4.deflateRaw;
// const { proxy } = require('@renderer/store');
var _require5 = require('tunnel'),
  httpOverHttp = _require5.httpOverHttp,
  httpsOverHttp = _require5.httpsOverHttp;
// const fs = require('fs');
