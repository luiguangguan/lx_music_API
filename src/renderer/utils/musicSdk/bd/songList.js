...
var _default = {
  ...
  aesPassEncod: function aesPassEncod(jsonData) {
    ...
    var arrData = [];
    var strData = '';
    for (var _key in jsonData) arrData.push(_key);
    arrData.sort();
  ...
  getTags: function getTags() {
    ...
    return this._requestObj_tags.promise.then(function (_ref) {
      var body = _ref.body;
      if (body.error_code !== _this.successCode) return _this.getTags(++tryNum);
      return {
  ...
  getList: function getList(sortId, tagId, page) {
    ...
    return this._requestObj_list.promise.then(function (_ref2) {
      var body = _ref2.body;
      if (body.error_code !== _this2.successCode) return _this2.getList(sortId, tagId, page, ++tryNum);
      return {
  ...
  getListDetail: function getListDetail(id, page) {
    ...
    return requestObj_listDetail.promise.then(function (_ref3) {
      var body = _ref3.body;
      if (body.error_code !== _this4.successCode) return _this4.getListDetail(id, page, ++tryNum);
