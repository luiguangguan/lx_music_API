...
var parseLyric = function parseLyric(str) {
  ...
  var lxlyric = str.replace(/\[((\d+),\d+)\].*/g, function (str) {
    ...
    if (rlyric) rlyric[i] = "[".concat(time, "]").concat((_rlyric$i$join = (_rlyric$i = rlyric[i]) === null || _rlyric$i === void 0 ? void 0 : _rlyric$i.join('')) !== null && _rlyric$i$join !== void 0 ? _rlyric$i$join : '');
    if (tlyric) tlyric[i] = "[".concat(time, "]").concat((_tlyric$i$join = (_tlyric$i = tlyric[i]) === null || _tlyric$i === void 0 ? void 0 : _tlyric$i.join('')) !== null && _tlyric$i$join !== void 0 ? _tlyric$i$join : '');
    i++;
