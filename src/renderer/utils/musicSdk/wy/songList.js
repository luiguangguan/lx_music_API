...
var _require4 = require('./utils/index'),
  eapiRequest = _require4.eapiRequest;
var _require5 = require('../utils'),
  formatSingerName = _require5.formatSingerName;
var _default = {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            if (cookie) _this3.cookie = cookie;
  ...
  filterListDetail: function filterListDetail(_ref) {
    var tracks = _ref.playlist.tracks,
  ...
  getHotTag: function getHotTag() {
    ...
    return this._requestObj_hotTags.promise.then(function (_ref5) {
      var body = _ref5.body;
      // console.log(JSON.stringify(body))
      if (body.code !== _this6.successCode) return _this6.getTag(++tryNum);
  ...
  search: function search(text, page) {
    ...
    return eapiRequest('/api/cloudsearch/pc', {
      ...
      var body = _ref8.body;
      if (body.code != _this8.successCode) throw new Error('filed');
      // console.log(body)
      return {
