...
var _require3 = require('./musicInfo'),
  filterMusicInfoList = _require3.filterMusicInfoList;
var _require4 = require('./musicSearch'),
  createSignature = _require4.createSignature;
var _require5 = require('./utils/index'),
  createHttpFetch = _require5.createHttpFetch;
...
var _default = {
  ...
  getListDetailList: function getListDetailList(id, page) {
    ...
    return requestObj_listDetail.promise.then(function (_ref) {
      var body = _ref.body;
      if (body.code !== _this.successCode) return _this.getListDetail(id, page, ++tryNum);
  ...
  getListDetailInfo: function getListDetailInfo(id) {
    ...
    return requestObj_listDetailInfo.promise.then(function (_ref2) {
      var body = _ref2.body;
      if (body.code !== _this2.successCode) return _this2.getListDetail(id, ++tryNum);
      // console.log(JSON.stringify(body))
      // console.log(body)
  ...
  getList: function getList(sortId, tagId, page) {
    ...
    return this._requestObj_list.promise.then(function (_ref5) {
      var body = _ref5.body;
      // console.log(body)
      if (body.retCode !== '100000' || body.retMsg.code !== _this4.successCode) return _this4.getList(sortId, tagId, page, ++tryNum);
      return {
  ...
  getTag: function getTag() {
    ...
    return this._requestObj_tags.promise.then(function (_ref6) {
      var body = _ref6.body;
      if (body.code !== _this5.successCode) return _this5.getTag(++tryNum);
      // console.log(body)
  ...
  filterTagInfo: function filterTagInfo(rawList) {
    return {
      hotTag: rawList[0].content.map(function (_ref7) {
        var _ref7$texts = _slicedToArray(_ref7.texts, 2),
          name = _ref7$texts[0],
          id = _ref7$texts[1];
        return {
          id: id,
      ...
      tags: rawList.slice(1).map(function (_ref8) {
        ...
        return {
          ...
          list: content.map(function (_ref9) {
            var _ref9$texts = _slicedToArray(_ref9.texts, 2),
              name = _ref9$texts[0],
              id = _ref9$texts[1];
            return {
