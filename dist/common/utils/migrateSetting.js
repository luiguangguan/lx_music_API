...
export default (setting) => {
    ...
    if (compareVer(setting.version, '2.0.0') < 0) {
        ...
        setting['theme.id'] = oldThemeMap[setting.theme?.id];
        setting['theme.lightId'] = oldThemeMap[setting.theme?.lightId];
        setting['theme.darkId'] = oldThemeMap[setting.theme?.darkId];
