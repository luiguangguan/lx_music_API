...
var _require3 = require('../index'), formatPlayTime = _require3.formatPlayTime, sizeFormate = _require3.sizeFormate;
// https://github.com/Binaryify/NeteaseCloudMusicApi/blob/master/module/song_detail.js
var _default = {
    getSinger: function getSinger(singers) {
        var arr = [];
        singers === null || singers === void 0 ? void 0 : singers.forEach(function (singer) {
            arr.push(singer.name);
        });
        return arr.join('、');
    },
    filterList: function filterList(_ref) {
        var _this = this;
        var songs = _ref.songs, privileges = _ref.privileges;
    ...
    getList: function getList() {
        ...
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var ids, retryNum, requestObj, _yield$requestObj$pro, body, statusCode;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            ids = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : [];
                            retryNum = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : 0;
                            if (!(retryNum > 2)) {
                                _context.next = 4;
                                break;
                            }
                            return _context.abrupt("return", Promise.reject(new Error('try max num')));
                        case 4:
                            requestObj = httpFetch('https://music.163.com/weapi/v3/song/detail', {
                                method: 'post',
                                headers: {
                        ...
                        case 7:
                            _yield$requestObj$pro = _context.sent;
                            body = _yield$requestObj$pro.body;
                            statusCode = _yield$requestObj$pro.statusCode;
