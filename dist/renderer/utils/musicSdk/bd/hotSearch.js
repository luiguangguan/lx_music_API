            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            _requestObj = httpFetch('http://musicapi.qianqian.com/v1/restserver/ting?from=android&version=7.0.2.0&channel=ppzs&operator=0&method=baidu.ting.search.hot', {
                                method: 'get',
                                headers: {
                        ...
                        case 12:
                            return _context.abrupt("return", {
                                source: 'bd',
                                list: _this.filterList(body.result)
                            });
                        case 13:
                        case "end":
