...
var _default = {
    getPicUrl: function getPicUrl(songId) {
        var _arguments = arguments, _this = this;
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var tryNum, requestObj;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            tryNum = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : 0;
                            requestObj = httpFetch("http://music.migu.cn/v3/api/music/audioPlayer/getSongPic?songId=".concat(songId), {
                                headers: {
                                    Referer: 'http://music.migu.cn/v3/music/player/audio?from=migu'
                                }
                            });
                            requestObj.promise.then(function (_ref) {
                                var body = _ref.body;
                                if (body.returnCode !== '000000') {
                                    if (tryNum > 5)
                                        return Promise.reject('图片获取失败');
                                    var tryRequestObj = _this.getPic(songId, ++tryNum);
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1)
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.next = 2;
                            return getSongId(songInfo);
                        case 2:
                            songId = _context2.sent;
                            return _context2.abrupt("return", _this2.getPicUrl(songId));
                        case 4:
                        case "end":
