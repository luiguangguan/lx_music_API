...
var _require = require('./utils'), createHttpFetch = _require.createHttpFetch;
var _require2 = require('./musicInfo'), filterMusicInfoList = _require2.filterMusicInfoList;
var _require3 = require('../index'), formatPlayCount = _require3.formatPlayCount;
var _default = {
    /**
     * 通过AlbumId获取专辑
     * @param {*} id
    ...
    getAlbumDetail: function getAlbumDetail(id) {
        ...
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var page, list, songList, listInfo;
                ...
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.next = 3;
                            return createHttpFetch("http://app.c.nf.migu.cn/MIGUM2.0/v1.0/content/queryAlbumSong?albumId=".concat(id, "&pageNo=").concat(page));
                        case 3:
                            list = _context.sent;
                            if (list.songList) {
                                _context.next = 6;
                            ...
                            return _context.abrupt("return", Promise.reject(new Error('Get album list error.')));
                        case 6:
                            songList = filterMusicInfoList(list.songList);
                            _context.next = 9;
                            return _this.getAlbumInfo(id);
                        case 9:
                            listInfo = _context.sent;
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1)
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.next = 2;
                            return createHttpFetch("https://app.c.nf.migu.cn/MIGUM3.0/resource/album/v2.0?albumId=".concat(id));
                        case 2:
                            info = _context2.sent;
                            if (info) {
                                _context2.next = 5;
                            ...
                            return _context2.abrupt("return", Promise.reject(new Error('Get album info error.')));
                        case 5:
