...
exports.getMusicInfos = exports.getMusicInfo = exports.filterMusicInfoList = void 0;
...
var _require = require('../index'), sizeFormate = _require.sizeFormate;
var _require2 = require('./utils'), createHttpFetch = _require2.createHttpFetch;
var _require3 = require('../utils'), formatSingerName = _require3.formatSingerName;
var createGetMusicInfosTask = function createGetMusicInfosTask(ids) {
    var list = ids;
    var tasks = [];
    while (list.length) {
...
var filterMusicInfoList = function filterMusicInfoList(rawList) {
    // console.log(rawList)
    var ids = new Set();
    var list = [];
    rawList.forEach(function (item) {
        var _item$newRateFormats, _item$albumImgs;
        if (!item.songId || ids.has(item.songId))
            return;
        ids.add(item.songId);
        var types = [];
        var _types = {};
        (_item$newRateFormats = item.newRateFormats) === null || _item$newRateFormats === void 0 ? void 0 : _item$newRateFormats.forEach(function (type) {
            var _type$size, _type$size2, _type$size3, _type$size4;
            var size;
            switch (type.formatType) {
                case 'PQ':
                    size = sizeFormate((_type$size = type.size) !== null && _type$size !== void 0 ? _type$size : type.androidSize);
                    types.push({
                        type: '128k',
                        size: size
                    });
                    ...
                    break;
                case 'HQ':
                    size = sizeFormate((_type$size2 = type.size) !== null && _type$size2 !== void 0 ? _type$size2 : type.androidSize);
                    types.push({
                        type: '320k',
                        size: size
                    });
                    ...
                    break;
                case 'SQ':
                    size = sizeFormate((_type$size3 = type.size) !== null && _type$size3 !== void 0 ? _type$size3 : type.androidSize);
                    types.push({
                        type: 'flac',
                        size: size
                    });
                    ...
                    break;
                case 'ZQ':
                    size = sizeFormate((_type$size4 = type.size) !== null && _type$size4 !== void 0 ? _type$size4 : type.androidSize);
                    types.push({
                        type: 'flac24bit',
                        size: size
                    });
        ...
        var intervalTest = /(\d\d:\d\d)$/.test(item.length);
        list.push({
            ...
            img: (_item$albumImgs = item.albumImgs) !== null && _item$albumImgs !== void 0 && _item$albumImgs.length ? item.albumImgs[0].img : null,
            lrc: null,
            lrcUrl: item.lrcUrl,
            mrcUrl: item.mrcUrl,
            trcUrl: item.trcUrl,
...
var getMusicInfo = /*#__PURE__*/ function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(copyrightId) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1)
                switch (_context.prev = _context.next) {
                    case 0:
                        return _context.abrupt("return", getMusicInfos([copyrightId]).then(function (data) {
                            return data[0];
                        }));
                    case 1:
                    case "end":
    ...
    return function getMusicInfo(_x) {
        return _ref.apply(this, arguments);
    };
}();
exports.getMusicInfo = getMusicInfo;
var getMusicInfos = /*#__PURE__*/ function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(copyrightIds) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1)
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.t0 = filterMusicInfoList;
                        _context2.next = 3;
                        return Promise.all(createGetMusicInfosTask(copyrightIds)).then(function (data) {
                            return data.flat();
                        });
                    case 3:
    ...
    return function getMusicInfos(_x2) {
