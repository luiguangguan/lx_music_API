...
var _default = {
    ...
    tipSearchBySong: function tipSearchBySong(str) {
        ...
        this.requestObj = createHttpFetch("https://music.migu.cn/v3/api/search/suggest?keyword=".concat(encodeURIComponent(str)), {
            headers: {
                referer: 'https://music.migu.cn/v3'
            }
        });
        return this.requestObj.then(function (body) {
            return body.songs;
        });
    },
    handleResult: function handleResult(rawData) {
        return rawData.map(function (info) {
            return "".concat(info.name, " - ").concat(info.singerName);
        });
    },
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.abrupt("return", _this.tipSearchBySong(str).then(function (result) {
                                return _this.handleResult(result);
                            }));
                        case 1:
                        case "end":
