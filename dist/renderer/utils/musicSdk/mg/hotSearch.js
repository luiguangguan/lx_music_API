            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            _requestObj = httpFetch('http://jadeite.migu.cn:7090/music_search/v3/search/hotword');
                            _context.next = 7;
                        ...
                        case 12:
                            return _context.abrupt("return", {
                                source: 'mg',
                                list: _this.filterList(body.data.hotwords[0].hotwordList)
                            });
                        case 13:
                        case "end":
