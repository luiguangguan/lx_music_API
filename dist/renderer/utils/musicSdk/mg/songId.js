...
var _require = require('./musicInfo'), getMusicInfo = _require.getMusicInfo;
var getSongId = /*#__PURE__*/ function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(mInfo) {
        var musicInfo;
            ...
            while (1)
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        return _context.abrupt("return", mInfo.songmid);
                    case 2:
                        _context.next = 4;
                        return getMusicInfo(mInfo.copyrightId);
                    case 4:
                        musicInfo = _context.sent;
                        return _context.abrupt("return", musicInfo.songmid);
                    case 6:
                    case "end":
