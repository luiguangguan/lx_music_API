...
var _require = require('./musicInfo'), getMusicInfosByList = _require.getMusicInfosByList;
...
var _default = {
     ...
     * @param {*} id
     */
    getAlbumInfo: function getAlbumInfo(id) {
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var albumInfoRequest, albumInfo;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return createHttpFetch('http://kmrserviceretry.kugou.com/container/v1/album?dfid=1tT5He3kxrNC4D29ad1MMb6F&mid=22945702112173152889429073101964063697&userid=0&appid=1005&clientver=11589', {
                                method: 'POST',
                                body: {
                                    appid: 1005,
                        ...
                        case 2:
                            albumInfoRequest = _context.sent;
                            if (albumInfoRequest) {
                                _context.next = 5;
                                break;
                            }
                            return _context.abrupt("return", Promise.reject(new Error('get album info failed.')));
                        case 5:
                            albumInfo = albumInfoRequest[0];
     ...
     * @param {*} page
     */
    getAlbumDetail: function getAlbumDetail(id) {
        var _arguments = arguments, _this = this;
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2() {
            var page, limit, albumList, result, info;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1)
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            page = _arguments.length > 1 && _arguments[1] !== undefined ? _arguments[1] : 1;
                            limit = _arguments.length > 2 && _arguments[2] !== undefined ? _arguments[2] : 200;
                            _context2.next = 4;
                            return createHttpFetch("http://mobiles.kugou.com/api/v3/album/song?version=9108&albumid=".concat(id, "&plat=0&pagesize=").concat(limit, "&area_code=0&page=").concat(page, "&with_res_tag=0"));
                        case 4:
                            albumList = _context2.sent;
                            if (albumList.info) {
                                _context2.next = 7;
                                break;
                            }
                            return _context2.abrupt("return", Promise.reject(new Error('Get album list failed.')));
                        case 7:
                            _context2.next = 9;
                            return getMusicInfosByList(albumList.info);
                        case 9:
                            result = _context2.sent;
                            _context2.next = 12;
                            return _this.getAlbumInfo(id);
                        case 12:
                            info = _context2.sent;
