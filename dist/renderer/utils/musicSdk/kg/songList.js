...
var _require2 = require('../index'), decodeName = _require2.decodeName, formatPlayTime = _require2.formatPlayTime, sizeFormate = _require2.sizeFormate, dateFormat = _require2.dateFormat, formatPlayCount = _require2.formatPlayCount;
...
var _default = {
    ...
    getSongList: function getSongList(sortId, tagId, page) {
        ...
        return this._requestObj_list.promise.then(function (_ref) {
            ...
            if (!body || body.status !== 1)
                return _this2.getSongList(sortId, tagId, page, ++tryNum);
    ...
    getSongListRecommend: function getSongListRecommend() {
        ...
        return this._requestObj_listRecommend.promise.then(function (_ref2) {
            var body = _ref2.body;
            if (body.status !== 1)
                return _this3.getSongListRecommend(++tryNum);
                    ...
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            return Promise.all(_this6.createTask(_this6.deDuplication(list).map(function (item) {
                                ...
                                var _ref4 = _toArray(_ref3), datas = _ref4.slice(0);
                                return datas.flat();
                            });
                        case 3:
    ...
    createGetListDetail2Task: function createGetListDetail2Task(id, total) {
        ...
        return Promise.all(tasks).then(function (_ref9) {
            var _ref10 = _toArray(_ref9), datas = _ref10.slice(0);
            return datas.flat();
        });
    },
    ...
    getListInfo: function getListInfo(tagId) {
        ...
        return this._requestObj_listInfo.promise.then(function (_ref11) {
            ...
            if (body.status !== 1)
                return _this18.getListInfo(tagId, ++tryNum);
            return {
    ...
    getList: function getList(sortId, tagId, page) {
        ...
        return Promise.all(tasks).then(function (_ref12) {
            var _ref13 = _slicedToArray(_ref12, 3), list = _ref13[0], info = _ref13[1], recommendList = _ref13[2];
            if (recommendList)
