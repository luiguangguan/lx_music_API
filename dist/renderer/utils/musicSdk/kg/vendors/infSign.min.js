...
!function (t, n) {
    "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : (t = t || self, t.infSign = n());
}(void 0, function () {
    "use strict";
    function t(t, n, r) {
    ...
    function c() {
        ...
        var f = function f() {
            var n = new Date().getTime(), i = [], s = [], u = "NVPh5oo715z5DIWAeQlhMDsWXXQV4hwt", f = {
                srcappid: "2919",
                clientver: "20000",
                clienttime: n,
                mid: n,
    ...
    var s = e(function (t, n) {
        !function (n, r) {
            t.exports = function () {
                var t = {
                    ...
                    formartData: function formartData(n, r) {
                ...
                return {
                    ...
                    isInClient: function isInClient() {
                        return !(!t.isAndroid && !t.isKugouAndroid && !t.isIOS);
                    },
                    mobileCall: function mobileCall(n, r, e) {
                        var o = "";
                        if (r && (o = t.json2Str(r)), !n)
                            return console.error("请输入命令号！"), !1;
                        var i = {};
                        n && (i.cmd = n), "" != o && (i.jsonStr = o), e && (i.callback = e), n && 186 == n && e && (i.AndroidCallback = !0), t.callCmd(i);
                    },
                    KgWebMobileCall: function KgWebMobileCall(t, n) {
                        if (t)
                            try {
                                var r = t.split(".");
        ...
        !function () {
            var n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = {
                rotl: function rotl(t, n) {
                    return t << n | t >>> 32 - n;
                },
                rotr: function rotr(t, n) {
                    return t << 32 - n | t >>> n;
                },
        ...
        !function () {
            var n = a, r = u.utf8, e = f, o = u.bin, i = function i(t, c) {
