...
var _default = {
    ...
    getInfo: function getInfo(id) {
        ...
        return createHttpFetch("http://mobiles.kugou.com/api/v5/singer/info?singerid=".concat(id)).then(function (body) {
            if (!body)
    ...
    getAlbumList: function getAlbumList(id) {
        ...
        return createHttpFetch("http://mobiles.kugou.com/api/v5/singer/album?singerid=".concat(id, "&page=").concat(page, "&pagesize=").concat(limit)).then(function (body) {
            if (!body.info)
                throw new Error('get singer album list faild.');
            var list = _this.filterAlbumList(body.info);
            return {
                source: 'kg',
                list: list,
                limit: limit,
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            _context.next = 6;
                            return createHttpFetch("http://mobiles.kugou.com/api/v5/singer/song?singerid=".concat(id, "&page=").concat(page, "&pagesize=").concat(limit));
                        case 6:
                            body = _context.sent;
                            if (body.info) {
                                _context.next = 9;
                        ...
                        case 9:
                            _context.next = 11;
                            return getMusicInfosByList(body.info);
                        case 11:
                            list = _context.sent;
