...
exports.getMusicInfosByList = exports.getMusicInfos = exports.getMusicInfo = exports.filterMusicInfoList = void 0;
...
var _require = require('../index'), decodeName = _require.decodeName, formatPlayTime = _require.formatPlayTime, sizeFormate = _require.sizeFormate;
var _require2 = require('./util'), createHttpFetch = _require2.createHttpFetch;
var createGetMusicInfosTask = function createGetMusicInfosTask(hashs) {
    var data = {
        appid: 1001,
...
var filterMusicInfoList = function filterMusicInfoList(rawList) {
    ...
    rawList.forEach(function (item) {
        ...
        if (item.audio_info.filesize_320 !== '0') {
            var _size = sizeFormate(parseInt(item.audio_info.filesize_320));
            types.push({
                type: '320k',
                size: _size,
        ...
        if (item.audio_info.filesize_flac !== '0') {
            var _size2 = sizeFormate(parseInt(item.audio_info.filesize_flac));
            types.push({
                type: 'flac',
                size: _size2,
        ...
        if (item.audio_info.filesize_high !== '0') {
            var _size3 = sizeFormate(parseInt(item.audio_info.filesize_high));
            types.push({
                type: 'flac24bit',
                size: _size3,
...
var getMusicInfos = /*#__PURE__*/ function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee(hashs) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1)
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.t0 = filterMusicInfoList;
                        _context.next = 3;
                        return Promise.all(createGetMusicInfosTask(hashs)).then(function (data) {
                            return data.flat();
                        });
                    case 3:
    ...
    return function getMusicInfos(_x) {
...
var getMusicInfo = /*#__PURE__*/ function () {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1)
                switch (_context2.prev = _context2.next) {
                    case 0:
                        return _context2.abrupt("return", getMusicInfos([hash]).then(function (data) {
                            return data[0];
                        }));
                    case 1:
                    case "end":
    ...
    return function getMusicInfo(_x2) {
        return _ref2.apply(this, arguments);
    };
}();
exports.getMusicInfo = getMusicInfo;
var getMusicInfosByList = function getMusicInfosByList(list) {
    return getMusicInfos(list.map(function (item) {
        return {
            hash: item.hash
        };
    }));
