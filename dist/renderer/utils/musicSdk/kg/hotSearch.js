            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            _requestObj = httpFetch('http://gateway.kugou.com/api/v3/search/hot_tab?signature=ee44edb9d7155821412d220bcaf509dd&appid=1005&clientver=10026&plat=0', {
                                method: 'get',
                                headers: {
                        ...
                        case 12:
                            return _context.abrupt("return", {
                                source: 'kg',
                                list: _this.filterList(body.data.list)
                            });
                        case 13:
                        case "end":
    ...
    filterList: function filterList(rawList) {
        ...
        rawList.forEach(function (item) {
            item.keywords.map(function (k) {
                return list.push(decodeName(k.keyword));
            });
        });
        return list;
    }
