...
var _require2 = require('../../utils'), formatSingerName = _require2.formatSingerName;
var _require3 = require('../../../index'), decodeName = _require3.decodeName, formatPlayTime = _require3.formatPlayTime, sizeFormate = _require3.sizeFormate, dateFormat = _require3.dateFormat, formatPlayCount = _require3.formatPlayCount;
var _require4 = require('./../util'), signatureParams = _require4.signatureParams, createHttpFetch = _require4.createHttpFetch;
var _require5 = require('../musicInfo'), getMusicInfosByList = _require5.getMusicInfosByList;
...
var _default = {
                    ...
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            if (id.includes('special/single/'))
                                id = id.replace(_this.regExps.listDetailLink, '$1');
    ...
    getSongList: function getSongList(sortId, tagId, page) {
        ...
        return this._requestObj_list.promise.then(function (_ref2) {
            ...
            if (!body || body.status !== 1)
                return _this3.getSongList(sortId, tagId, page, ++tryNum);
    ...
    getSongListRecommend: function getSongListRecommend() {
        ...
        return this._requestObj_listRecommend.promise.then(function (_ref3) {
            var body = _ref3.body;
            if (body.status !== 1)
                return _this4.getSongListRecommend(++tryNum);
                    ...
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            ...
                            return Promise.all(tasks).then(function (_ref5) {
                                var _ref6 = _toArray(_ref5), datas = _ref6.slice(0);
                                return datas.flat();
                            });
                        case 8:
    ...
    createGetListDetail2Task: function createGetListDetail2Task(id, total) {
        ...
        return Promise.all(tasks).then(function (_ref7) {
            var _ref8 = _toArray(_ref7), datas = _ref8.slice(0);
            return datas.flat();
        });
    },
    ...
    getUserListDetail: function getUserListDetail(link, page) {
        var _arguments4 = arguments, _this15 = this;
    ...
    getListInfo: function getListInfo(tagId) {
        ...
        return this._requestObj_listInfo.promise.then(function (_ref9) {
            var body = _ref9.body;
            if (body.status !== 1)
                return _this16.getListInfo(tagId, ++tryNum);
            return {
    ...
    getList: function getList(sortId, tagId, page) {
        ...
        return Promise.all(tasks).then(function (_ref10) {
            var _ref11 = _slicedToArray(_ref10, 3), list = _ref11[0], info = _ref11[1], recommendList = _ref11[2];
            if (recommendList)
                list.unshift.apply(list, _toConsumableArray(recommendList));
