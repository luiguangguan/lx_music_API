...
var _require = require('./util'), createHttpFetch = _require.createHttpFetch;
var _default = {
    requestObj: null,
    ...
    tipSearchBySong: function tipSearchBySong(str) {
        ...
        this.requestObj = createHttpFetch("https://searchtip.kugou.com/getSearchTip?MusicTipCount=10&keyword=".concat(encodeURIComponent(str)), {
            headers: {
