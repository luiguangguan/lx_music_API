...
var _default = {
    ...
    // },
    requestObj: null,
    tipSearch: function tipSearch(str) {
        this.cancelTipSearch();
        this.requestObj = httpFetch("https://c.y.qq.com/splcloud/fcgi-bin/smartbox_new.fcg?is_xml=0&format=json&key=".concat(encodeURIComponent(str), "&loginUin=0&hostUin=0&format=json&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0"), {
            headers: {
                Referer: 'https://y.qq.com/portal/player.html'
            }
        });
        return this.requestObj.promise.then(function (_ref) {
    ...
    handleResult: function handleResult(rawData) {
        return rawData.map(function (info) {
            return "".concat(info.name, " - ").concat(info.singer);
        });
    },
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.abrupt("return", _this.tipSearch(str).then(function (result) {
                                return _this.handleResult(result.song.itemlist);
                            }));
                        case 1:
                        case "end":
