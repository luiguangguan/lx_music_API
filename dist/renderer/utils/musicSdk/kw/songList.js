...
var _require2 = require('../index'), formatPlayTime = _require2.formatPlayTime, decodeName = _require2.decodeName;
...
var _default = {
    ...
    getListUrl: function getListUrl(_ref) {
        var sortId = _ref.sortId, id = _ref.id, type = _ref.type, page = _ref.page;
        if (!id)
            return "http://wapi.kuwo.cn/api/pc/classify/playlist/getRcmPlayList?loginUid=0&loginSid=0&appUid=76039576&&pn=".concat(page, "&rn=").concat(this.limit_list, "&order=").concat(sortId);
        switch (type) {
            case '10000':
    ...
    getHotTag: function getHotTag() {
        ...
        return this._requestObj_hotTags.promise.then(function (_ref3) {
            ...
            if (body.code !== _this2.successCode)
                return _this2.getHotTag(++tryNum);
    ...
    getList: function getList(sortId, tagId, page) {
        ...
        return this._requestObj_list.promise.then(function (_ref4) {
            var body = _ref4.body;
            if (!id || type == '10000') {
                if (body.code !== _this3.successCode)
    ...
    getListDetailDigest8: function getListDetailDigest8(id, page) {
        ...
        return requestObj.promise.then(function (_ref5) {
            var body = _ref5.body;
            if (body.result !== 'ok')
                return _this6.getListDetail(id, page, ++tryNum);
            return {
    ...
    getListDetailDigest5Info: function getListDetailDigest5Info(id) {
        ...
        return requestObj.promise.then(function (_ref6) {
            var statusCode = _ref6.statusCode, body = _ref6.body;
            if (statusCode != 200 || !body.child)
                return _this7.getListDetail(id, ++tryNum);
            // console.log(body)
    ...
    getListDetailDigest5Music: function getListDetailDigest5Music(id, page) {
        ...
        return requestObj.promise.then(function (_ref7) {
            ...
            // console.log(body)
            if (body.result !== 'ok')
                return _this8.getListDetail(id, page, ++tryNum);
            return {
    ...
    filterBDListDetail: function filterBDListDetail(rawList) {
        return rawList.map(function (item) {
            var types = [];
            var _types = {};
            var _iterator = _createForOfIteratorHelper(item.audios), _step;
            try {
    ...
    getListDetail: function getListDetail(id, page) {
        ...
        if (/[?&:/]/.test(id))
            ...
            var _id$split = id.split('__'), _id$split2 = _slicedToArray(_id$split, 2), digest = _id$split2[0], _id = _id$split2[1];
    ...
    filterListDetail: function filterListDetail(rawData) {
        ...
        return rawData.map(function (item) {
            ...
            var types = [];
            var _types = {};
            var _iterator2 = _createForOfIteratorHelper(infoArr), _step2;
            try {
    ...
    getTags: function getTags() {
        return Promise.all([this.getTag(), this.getHotTag()]).then(function (_ref8) {
            var _ref9 = _slicedToArray(_ref8, 2), tags = _ref9[0], hotTag = _ref9[1];
            return {
                tags: tags,
                hotTag: hotTag,
                source: 'kw'
