...
var _require = require('../index'), decodeName = _require.decodeName;
var _require2 = require('./util'), tokenRequest = _require2.tokenRequest;
var _default = {
    regExps: {
        relWord: /RELWORD=(.+)/
    },
    requestObj: null,
    tipSearchBySong: function tipSearchBySong(str) {
        var _this = this;
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            _this.cancelTipSearch();
                            _context.next = 3;
                            return tokenRequest("http://www.kuwo.cn/api/www/search/searchKey?key=".concat(encodeURIComponent(str)));
                        case 3:
                            _this.requestObj = _context.sent;
                            return _context.abrupt("return", _this.requestObj.promise.then(function (_ref) {
                                var body = _ref.body;
                                // console.log(body)
                                if (body.code !== 200)
    ...
    handleResult: function handleResult(rawData) {
        var _this2 = this;
        return rawData.map(function (info) {
            var matchResult = info.match(_this2.regExps.relWord);
            return matchResult ? decodeName(matchResult[1]) : '';
        });
    },
    cancelTipSearch: function cancelTipSearch() {
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1)
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            return _context2.abrupt("return", _this3.tipSearchBySong(str).then(function (result) {
                                return _this3.handleResult(result.data);
                            }));
                        case 1:
                        case "end":
