...
var _default = {
    ...
    getList: function getList() {
        ...
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var retryNum, _requestObj, _yield$_requestObj$pr, body, statusCode;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            _requestObj = httpFetch('http://hotword.kuwo.cn/hotword.s?prod=kwplayer_ar_9.3.0.1&corp=kuwo&newver=2&vipver=9.3.0.1&source=kwplayer_ar_9.3.0.1_40.apk&p2p=1&notrace=0&uid=0&plat=kwplayer_ar&rformat=json&encoding=utf8&tabid=1', {
                                headers: {
                        ...
                        case 12:
                            return _context.abrupt("return", {
                                source: 'kw',
                                list: _this.filterList(body.tagvalue)
                            });
                        case 13:
                        case "end":
    ...
    filterList: function filterList(rawList) {
