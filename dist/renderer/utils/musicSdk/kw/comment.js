...
var _default = {
    ...
    getComment: function getComment(_ref) {
        ...
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var songmid, page, limit, _requestObj, _yield$_requestObj$pr, body, statusCode;
                ...
                while (1)
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _requestObj = httpFetch("http://comment.kuwo.cn/com.s?type=get_comment&uid=0&digest=15&sid=".concat(songmid, "&page=").concat(page, "&rows=").concat(limit, "&f=web&prod=MUSIC_8.7.7.0_BCS37&devid=28556413"), {
                                headers: {
                        ...
                        case 12:
                            return _context.abrupt("return", {
                                source: 'kw',
                                comments: _this.filterComment(body.rows),
                                total: body.total,
                                page: page,
                                limit: limit,
    ...
    getHotComment: function getHotComment(_ref2) {
        ...
        return _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2() {
            var songmid, page, limit, _requestObj2, _yield$_requestObj2$p, body, statusCode;
                ...
                while (1)
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            _requestObj2 = httpFetch("http://comment.kuwo.cn/com.s?type=get_rec_comment&uid=0&digest=15&sid=".concat(songmid, "&page=").concat(page, "&rows=").concat(limit, "&f=web&prod=MUSIC_8.7.7.0_BCS37&devid=28556413"), {
                                headers: {
                                    'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 9;)'
                                }
                            });
                        ...
                        case 12:
                            return _context2.abrupt("return", {
                                source: 'kw',
                                comments: _this2.filterComment(body.rows),
                                total: body.total,
                                page: page,
                                limit: limit,
                                maxPage: Math.ceil(body.total / limit) || 1
