...
var _require = require('./chinese'), simplified = _require.simplified, traditional = _require.traditional;
var stMap = new Map();
var tsMap = new Map();
...
function simplify(source) {
    var result = [];
    var _iterator = _createForOfIteratorHelper(source), _step;
    try {
...
function tranditionalize(source) {
    var result = [];
    var _iterator2 = _createForOfIteratorHelper(source), _step2;
    try {
