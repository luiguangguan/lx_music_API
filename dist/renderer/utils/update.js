...
var _require = require('./request.js'), httpGet = _require.httpGet;
var _require2 = require('../../../package.json'), author = _require2.author, name = _require2.name;
// TODO add Notice
var getVersionInfo = /*#__PURE__*/ function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
        var retryNum, _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1)
                switch (_context.prev = _context.next) {
                    case 0:
                        retryNum = _args.length > 0 && _args[0] !== undefined ? _args[0] : 0;
                        _context.next = 3;
                        return new Promise(function (resolve, reject) {
                            httpGet("https://raw.githubusercontent.com/".concat(author.name, "/").concat(name, "/master/publish/version.json"), {
                                timeout: 20000
                            }, function (err, resp, body) {
                                if (err) {
                                    return ++retryNum > 3 ? getVersionInfo2().then(resolve)["catch"](reject) : getVersionInfo(retryNum).then(resolve)["catch"](reject);
                                }
                                resolve(body);
                            });
                        });
...
var getVersionInfo2 = /*#__PURE__*/ function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2() {
        var retryNum, _args2 = arguments;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1)
                switch (_context2.prev = _context2.next) {
                    case 0:
                        retryNum = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 0;
                        _context2.next = 3;
                        return new Promise(function (resolve, reject) {
                            httpGet('https://gitee.com/lyswhut/lx-music-desktop-versions/raw/master/version.json', {
                                ...
                                if (err) {
                                    return ++retryNum > 3 ? getVersionInfo3().then(resolve)["catch"](reject) : getVersionInfo2(retryNum).then(resolve)["catch"](reject);
                                }
                                resolve(body);
                            });
                        });
    ...
    return function getVersionInfo2() {
        return _ref2.apply(this, arguments);
    };
}();
var getVersionInfo3 = /*#__PURE__*/ function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee3() {
        var retryNum, _args3 = arguments;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1)
                switch (_context3.prev = _context3.next) {
                    case 0:
                        retryNum = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : 0;
                        _context3.next = 3;
                        return new Promise(function (resolve, reject) {
                            httpGet('https://cdn.stsky.cn/lx-music/desktop/version.json', {
                                ...
                                if (err) {
                                    return ++retryNum > 3 ? reject(err) : getVersionInfo3(retryNum).then(resolve)["catch"](reject);
                                }
                                resolve(body);
                            });
                        });
    ...
    return function getVersionInfo3() {
